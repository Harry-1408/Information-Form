(function (namespace, $) {
	...
	p._initDatePicker = function () {
		...
		$('#demo-date-month_girl1_ach1').datepicker({autoclose: true, todayHighlight: true, minViewMode: 1});
		$('#demo-date-month_girl1_ach2').datepicker({autoclose: true, todayHighlight: true, minViewMode: 1});
		$('#demo-date-month_girl1_ach3').datepicker({autoclose: true, todayHighlight: true, minViewMode: 1});
		$('#demo-date-month_girl1_ach4').datepicker({autoclose: true, todayHighlight: true, minViewMode: 1});
